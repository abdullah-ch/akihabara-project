...
export default class CreateMovieList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      movieName: "",
  ...
  onChangeScreenplay(event) {
    ...
    console.log(" Screenplay is written by", this.state.s);
  }
  /////////////////////////////////////
  ...
  onSubmit(event) {
    ...
    axios
      .post("http://localhost:5000/movies/add", movies)
    ...
    return (
      <div>
        ...
        <form onSubmit={this.onSubmit}>
          ...
          />
          <br></br>
          <h2>Enter the Screenplay writer </h2>
          <br></br>
          <input
            className="form-control"
            type="text"
